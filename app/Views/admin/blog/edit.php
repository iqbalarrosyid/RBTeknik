    ...
    <div class="container">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header py-3">
                <h2 class="fw-bold mb-0"><i class="bi bi-pencil-square me-2"></i> Edit Artikel</h2>
            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (!empty($blog['thumbnail'])): ?>
                            <div id="image-preview">
                                <img src="<?= base_url('uploads/blog/' . $blog['thumbnail']); ?>" class="preview-thumbnail" alt="Thumbnail Lama">
                            </div>
                        <?php else: ?>
